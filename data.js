...
const WEAPONS = {
  ...
  m1_garand: {
    ...
    attackSlots: ['front', 'mid', 'back'], noMoveAfterAttack: true,
  ...
  desert_eagle: {
    ...
    recoilDodgePenalty: 15, noMoveAfterAttack: true, posAccuracyPenalty: { mid: 20 },
    weaponSkills: ['magnum_break'],
    desc: '高威力だが撃った後は移動不可・回避率低下。中衛で命中率-20%。',
  },
  glock17: {
...
const SKILLS = {
  ...
  armor_break:      { id:'armor_break',      name:'アーマーブレイク',       type:'passive', tree:'fire',    tier:2, desc:'攻撃時、敵の軽減率を無効化／自分の軽減も0になる',  effect:{ armorBreak:true, selfVulnerable:true } },
  killer_instinct:  { id:'killer_instinct',  name:'キラーインスティンクト', type:'passive', tree:'fire',    tier:3, desc:'敵を倒したターン追加攻撃／発動時HP10%消費',    effect:{ killExtraAttack:true, hpCostOnKill:0.1 } },
  ...
  magnum_break:     { id:'magnum_break',     name:'マグナムブレイク',       type:'active',  tree:'fire',    tier:3, ct:5, apCost:2, category:'weapon', desc:'2.5倍ダメージ＋敵後退（1Tスタン）／次ターンAP-1', effect:{ damageMod:2.5, pushBack:true, nextTurnApPenalty:1 } },
  // 🔵 回避系
  last_stand:       { id:'last_stand',       name:'ラストスタンド',         type:'passive', tree:'dodge',   tier:1, desc:'HP1で耐える（1バトル1回）／発動後1TはATK-30%', effect:{ lastStand:true, postActivateAtkDebuff:0.3 } },
  dodge_master:     { id:'dodge_master',     name:'ダッジマスター',         type:'passive', tree:'dodge',   tier:1, desc:'回避率+20%／攻撃力-10%',                     effect:{ dodgeRate:20, atkPenalty:0.1 } },
  counter:          { id:'counter',          name:'カウンター',             type:'passive', tree:'dodge',   tier:2, desc:'回避成功時、反撃（通常攻撃の50%）',         effect:{ counterAttack:0.5 } },
  shadow_step:      { id:'shadow_step',      name:'シャドウステップ',       type:'passive', tree:'dodge',   tier:2, desc:'移動にAPを消費しない',                    effect:{ freeMoveAp:true } },
  ...
  revive:           { id:'revive',           name:'蘇生',                   type:'active',  tree:'heal',    tier:3, ct:8, apCost:2, desc:'戦闘不能の味方をHP20%で復活／自分HP-30%', effect:{ revive:true, reviveHp:0.2, selfHpCost:0.3 } },
  // 🟡 妨害・戦術系
...
const BOSSES = {
  ...
  alpha_01: {
    ...
    hp: 2000, atk: 55, reduction: 0.15, speed: 8,
    ...
    drops: {
      ...
      weapons: [
        { weaponId:'thompson', name:'トンプソン（感染体改造）', rarity:'uncommon' },
        { weaponId:'mp40',     name:'MP40（鹵獲品）',           rarity:'rare'     },
        { weaponId:'m1911',    name:'α-01の拳銃',              rarity:'epic',    highlight: true },
        { weaponId:'kar98k',   name:'感染兵士のKar98k',         rarity:'rare'     },
      ],
  ...
  crawler: {
    ...
    hp: 3500, atk: 90, reduction: 0.2, speed: 10,
    ...
    drops: {
      ...
      weapons: [
        { weaponId:'ak47', name:'AK-47（変異体部隊回収品）', rarity:'rare'     },
        { weaponId:'pkm',  name:'クロウラーが持っていたPKM', rarity:'rare'     },
        { weaponId:'m14',  name:'M14（戦場回収品）',         rarity:'epic',    highlight: true },
        { weaponId:'uzi',  name:'Uzi（クロウラー改造）',     rarity:'uncommon' },
      ],
  ...
  titan: {
    ...
    hp: 3200, atk: 130, reduction: 0.3, speed: 6,
    ...
    drops: {
      ...
      weapons: [
        { weaponId:'barrett_m82',  name:'対タイタン狙撃銃',   rarity:'epic'             },
        { weaponId:'m249',         name:'実験体部隊のM249',    rarity:'rare'             },
        { weaponId:'hk416',        name:'タイタン護衛のHK416', rarity:'epic'             },
        { weaponId:'desert_eagle', name:'タイタンキラー',      rarity:'legend', highlight: true },
      ],
  ...
  nemea: {
    ...
    hp: 4500, atk: 180, reduction: 0.35, speed: 14,
    ...
    drops: {
      ...
      weapons: [
        { weaponId:'cheytac_m200', name:'ネメアの眼',   rarity:'legend', highlight: true },
        { weaponId:'ak12',         name:'追跡者の怒り', rarity:'legend'                  },
        { weaponId:'sig_p320',     name:'ネメアの爪',   rarity:'legend'                  },
      ],
